    ...
    if (layer.name === "boundaries") {
      for (const boundary of layer.objects) {
       ...
       let currentInteractTarget = null;
        ...
        const confirmBtn = document.getElementById("interact");
        const confirmContainer = document.getElementById("confirm-container");

        // When the player clicks "Open", show the textbox
        confirmBtn.addEventListener("click", () => {
          ...
          displayDialogue(
            dialogueData[currentInteractTarget],
            () => {
        ...
        if (boundary.name) {
          player.onCollide(boundary.name, () => {
            ...
            currentInteractTarget = boundary.name;
            confirmContainer.style.display = "block";
            }
          });

          //clear when no longer touching
